      ...
      >
        ...
        <div className="px-5 py-4">
          ...
          <div className="flex flex-col gap-2.5 text-sm">
            ...
            <a href={`tel:${personal.phone}`} className={`flex items-center gap-3 ${linkClass}`}>
              <Phone size={14} className="text-t-dim shrink-0" />
              {personal.phone}
            </a>
            <a href={`https://wa.me/${personal.whatsapp.replace("+", "")}`} target="_blank" rel="noopener noreferrer" className={`flex items-center gap-3 ${linkClass}`}>
              <svg viewBox="0 0 24 24" width="14" height="14" fill="currentColor" className="text-t-dim shrink-0">
