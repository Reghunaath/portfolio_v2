...
window.GAME_DATA = (function () {
  ...
  const dialogs = {
    ...
    "hub-map": {
      ...
      title: "World Map",
      body: [
        "Two unofficial trails run off the edge of this map.",
        "One heads south, to a cable you really shouldn't pull. One heads west, to a book that won't sit straight.",
      ],
      hint: "study the map",
    },
    "hub-trophy": {
    ...
    "edu-neu": {
      ...
      core: true,
      hint: "read the Northeastern masters degree",
    },
    "edu-vit": {
      ...
      core: true,
      hint: "read the VIT bachelors degree",
    },
    "edu-paper": {
