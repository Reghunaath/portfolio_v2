...
| Chessboard floor (stone checker swatch, 8px cells @ 192,64, cell layout scaled to full 16px tiles) | `Room_Builder_subfiles/Room_Builder_Floors_16x16.png` | `CHESS_LIGHT_GRID` / `CHESS_DARK_GRID` / `PAL_CHESS`, `floorChessboard` tile painter — hidden basement floor |
| Stairwell down, 32x32 (dark-stone stairs rails @ 0,176 + navy step strips @ 64,438, treads stacked into the door-void black) | `Room_Builder_subfiles/Room_Builder_Floor_Connectors_16x16.png` | `STAIRWELL_GRID` / `PAL_STAIRWELL`, `stairsDown` painter — library's hidden basement staircase |
| Seated stone statue with engraved pedestal plaque (26x48 @ 3,800, first of three copies) | `22_Museum_Shadowless.png` | `STATUE_GRID` / `PAL_STATUE`, `basementStatue` painter — the basement's "Finders' Ledger" monument |
