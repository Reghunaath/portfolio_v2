...
| Room | Section |
| --- | --- |
| `~/lobby` | Lobby — reception desk with a receptionist who checks you in by name (skippable), plus the whoami battlestation, TV, cat, coffee |
...
- On first launch the receptionist asks for the visitor's name ("just browsing" skips
  it, and it won't nag again). The name personalizes greetings and the 100% trophy,
  and can be changed anytime at the front desk.
